...
function not_show_switch_mode() {

  let elem_start_your_order_text = document.querySelector('#ele_switch_mode')
  elem_start_your_order_text.className = 'not_show_button_line_to_article_page'


}
function show_switch_mode() {

  let elem_start_your_order_text = document.querySelector('#ele_switch_mode')
  elem_start_your_order_text.className = 'show_button_line_to_article_page'
}
